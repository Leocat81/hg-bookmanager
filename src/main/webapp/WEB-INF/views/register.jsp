...
<html lang="zh-CN">
  <head>
    ...
    <title>spring mvc + spring + Mybatis - 登录</title>
  ...
  <body>
  	<div class="container">
  		...
  		<%-- 登录表单 --%>
  		<form:form action="register" modelAttribute="user" cssClass="form-horizontal">
  			<%-- 表单元素都需要样式form-group --%>
	  		...
	  		<div class="form-group">
	  			...
	  			<div class="col-md-offset-4 col-md-8">
	  				...
	  				<a href="/login" class="btn">已有账号！  马上登录</a>
	  			</div>
	  		</div>
  		</form:form>
  	</div>
    ...
    <script src="${pageContext.request.contextPath}/assets/bootstrapvalidator-0.5.3-dist/js/bootstrapValidator.min.js"></script>
   	<%-- 引入登录表单验证的脚本文件 --%>
    <script src="${pageContext.request.contextPath}/assets/register.js"></script>
  </body>
</html>