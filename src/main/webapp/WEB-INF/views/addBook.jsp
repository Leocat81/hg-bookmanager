...
<content tag="page.js">
   	<%-- 引入添加图书表单验证的脚本文件 --%>
    <script src="${pageContext.request.contextPath}/assets/addBook.js"></script>
</content>
		...
		<c:if test="${not empty requestScope.msg}">
	  	...
	  	<form:form modelAttribute="book" cssClass="form-horizontal">
	  		...
	  		<div class="form-group">
	  			...
	  			<div class="col-md-6">
	  				<form:select path="publishing.id" items="${sessionScope.publishing}" itemLabel="name" itemValue="id" cssClass="form-control" placeholder="请选择出版社">
	  				</form:select>
